 ...
 * 
 */
#define HTTPS_ERR_OK                            0   // OK
#define HTTPS_ERR_INVALIDPARAM                  -1  // invalid parameters, maybe some parameters are nullptr
#define HTTPS_ERR_INVALIDCALL                   -2  // invalid calling stack
#define HTTPS_ERR_URLSCHEME_WRONG               -3  // scheme(https or http) in url is not same as setting.
#define HTTPS_ERR_MBEDTLS_SEED_FAILED           -10 // set mbedtls drgb seed failed
#define HTTPS_ERR_MBEDTLS_CACERT_WRONG          -11 // mbedtls library parse ca certitifcate chain string failed
#define HTTPS_ERR_MBEDTLS_CONFIG_FAILED         -12 // mbedtls config failed
#define HTTPS_ERR_MBEDTLS_CONNECT_FAILED        -13 // mbedtls connect failed
#define HTTPS_ERR_MBEDTLS_SSL_SETUP_FAILED      -14 // ssl setup failed in mbedtls
#define HTTPS_ERR_MBEDTLS_SSL_HOST_FAILED       -15 // set host name failed in mbedtls
#define HTTPS_ERR_MBEDTLS_HANDSHAKE_FAILED      -16 // handshake failed in mbedtls
#define HTTPS_ERR_MBEDTLS_CERT_VERIFY_FAILED    -17 // verify host ssl certificate failed in mbedtls
#define HTTPS_ERR_MBEDTLS_WRITE_FAILED          -18 // mbedtls write data failed
#define HTTPS_ERR_MBEDTLS_READ_FAILED           -19 // mbedtls read data failed
#define HTTPS_ERR_FAILED_TO_MALLOC              -20 // failed to malloc memory
